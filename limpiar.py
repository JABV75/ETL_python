...
for i in x:
    file_path = '/Users/josebenvenuto/Desktop/ETL/' + i + '.csv'
    ...
    df = df.drop(['SOURCE_NAME', 'CUST_ACCOUNT_ID', 'SITE_USE_CODE', 'LOCATION', 'SITE_SHIP_TO',
                  'LOCATION_SHIP_TO', 'WAREHOUSE_ID','TAX_RATE', 'ORG_ID', 'INTERFACE_HEADER_ATTRIBUTE2',
                  'CUST_TRX_TYPE_ID', 'PARTY_SITE_ID', 'SEGMENT4', 'X'], axis=1)
...
all_data.to_csv('/Users/josebenvenuto/Desktop/ETL/cleaned_file.csv', index=False, encoding='utf-8')
